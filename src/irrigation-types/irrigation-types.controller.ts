...
export class IrrigationTypesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Tipo de irrigação atualizado com sucesso.',
  })
  @ApiResponse({
    status: 404,
    description: 'Tipo de irrigação não encontrado.',
  ...
  async update(
    ...
    return await this.irrigationTypesService.update(
      id,
      updateIrrigationTypeDto,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Tipo de irrigação removido com sucesso.',
  })
  @ApiResponse({
    status: 404,
    description: 'Tipo de irrigação não encontrado.',
